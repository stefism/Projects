...
namespace EFCoreDemo_CodeFirst
{
    ...
    // Като се правят миграции. Първата миграция създава базата!!! Базата се създава със прилагането на първата миграция, а не първо да създадеме базата и тогава да направиме първата миграция!
