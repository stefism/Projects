import { createComment, getCommentsByRecipeId } from '../api/comment-service.js';
...
export function commentsView(context, recipeId) {
    ...
    async function onSubmit({ content }) {
        ...
        result.owner = { username: context.user.username };
